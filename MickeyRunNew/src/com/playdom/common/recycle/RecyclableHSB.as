...
*/
////////////////////////////////////////////////////////////////////////////////
// (derived from mx.utils.HSBColor)
...
package com.playdom.common.recycle
{
	...
	/**
	 * Represents an HSB color value.
	 */
	public class RecyclableHSB implements IDestroyable
	{
		/** The recycling pool */
		private static var pool:Array = [];
		
		public static function make(hue:Number, saturation:Number, brightness:Number):RecyclableHSB
		{
			// recycle or create an instance
			if (pool.length > 0)
			{
				var instance:RecyclableHSB = pool.pop();
			}
			else
			{
				instance = new RecyclableHSB();
			}
			instance.hue = hue;
		 ...
		 *  @productversion Flex 4
		 */
		static public function convertRGBtoHSB(rgb:uint):RecyclableHSB
		{
			// Conversion taken from Foley, van Dam, et al
			...
			return RecyclableHSB.make(hue, saturation, brightness);
		}
