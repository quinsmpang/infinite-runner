		...
		var anchor:Vec2;
			...
			body.cbType = cbtype("null");
				...
				cbType = cbtype("null");
						...
						s = new Polygon(
							[   Vec2.weak(768,436)   ,  Vec2.weak(-28,446)   ,  Vec2.weak(-28,486)   ],
							mat,
							filt
						);
						s.body = body;
				...
				cbType = cbtype("null");
						...
						s = new Polygon(
							[   Vec2.weak(866,430)   ,  Vec2.weak(1278,460)   ,  Vec2.weak(1292,350)   ],
							mat,
							filt
						);
						s.body = body;
				...
				cbType = cbtype("null");
						...
						s = new Polygon(
							[   Vec2.weak(1350,710)   ,  Vec2.weak(-30,722)   ,  Vec2.weak(0,772)   ],
							mat,
							filt
						);
						s.body = body;
			...
			anchor = (true) ? body.localCOM.copy() : Vec2.get(0,780);
			body.translateShapes(Vec2.weak(-anchor.x,-anchor.y));
			body.position.setxy(0,0);

			bodies["bite sized 1"] = new BodyPair(body,anchor);
